...
export default function HowToGetDeviceSection({ inline = false }: { inline?: boolean }) {
  if (inline) {
    return (
      <div>
        <div className="mx-auto max-w-4xl text-center mb-8">
          <h2 className="text-3xl font-bold text-white">How to Get Your Device</h2>
          <p className="mt-2 text-white/80">Follow these quick steps to purchase, schedule installation, and get online fast.</p>
        </div>
        <Stepper
          initialStep={1}
          nextButtonText="Next"
        ...
        >
          <Step>
          <h3 className="text-xl font-semibold text-white">1. Choose Your Device</h3>
          <p className="mt-2 text-white/80">Select from our product range (e.g., Starlink Gen3 v4 Standard Dish, Flat High Performance, or Starlink Mini) based on your needs.</p>
          </Step>
          <Step>
          <h3 className="text-xl font-semibold text-white">2. Share Site Details</h3>
          <p className="mt-2 text-white/80">Provide your location and any special requirements. We verify coverage and recommend mounts, cabling, and Wi‑Fi distribution.</p>
          </Step>
          <Step>
          <h3 className="text-xl font-semibold text-white">3. Get Quote & Schedule</h3>
          <p className="mt-2 text-white/80">Receive a tailored quote. Once approved, we schedule installation at your convenience.</p>
          </Step>
          <Step>
          <h3 className="text-xl font-semibold text-white">4. Installation & Activation</h3>
          <p className="mt-2 text-white/80">Our team installs, aligns, and activates your Starlink. We test Wi‑Fi coverage and hand over.</p>
          </Step>
        </Stepper>
      </div>
    );
