...
export default function About() {
  return (
    <div className="flex flex-col">
      <Seo
        title="About Starlink Global Network | Starlink Installers in Nigeria"
        description="Learn about Starlink Global Network, a team of certified Starlink installers and network engineers providing dependable internet connectivity projects across Nigeria."
      />
          ...
          <div className="relative md:h-[520px]">
            ...
            <div className="relative h-full overflow-hidden rounded-[32px] border border-white/20 bg-white/5 shadow-[0_30px_60px_rgba(0,0,0,0.45)] backdrop-blur">
              <img
                ...
                alt="About Starlink Global Network"
